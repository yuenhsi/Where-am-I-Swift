...
SWIFT_CLASS("_TtC11Where_am_I_11AppDelegate")
...
SWIFT_CLASS("_TtC11Where_am_I_14ViewController")
...
@property (nonatomic, weak) IBOutlet UILabel * __null_unspecified longtitudeLabel;
@property (nonatomic, weak) IBOutlet UILabel * __null_unspecified altitudeLabel;
@property (nonatomic, weak) IBOutlet UILabel * __null_unspecified courseLabel;
